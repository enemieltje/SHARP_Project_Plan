...
\newcommand{\ACTtable}{%
    \begin{tabularx}{\textwidth}{|l|X|l|}%
        \hline%
        \textbf{WP\#} & \textbf{Activity} & \textbf{Hours} \\
        \hline%
...
{\formatdate{2}{2}{2026}}{\formatdate{15}{2}{2026}}
{80}

\ACTadd{WP-1}{1}{Literature study on hydrogen storage and fuel cells}{30}
\ACTadd{WP-1}{2}{Analysis of mission scenario and constraints}{20}
\ACTadd{WP-1}{3}{Definition of functional and safety requirements}{25}
\ACTadd{WP-1}{4}{Definition of test strategy and success criteria}{20}
\ACTadd{WP-1}{5}{Writing and finalising the project plan}{25}
...
{\formatdate{16}{2}{2026}}{\formatdate{22}{3}{2026}}
{200}

\ACTadd{WP-2}{1}{dummy}{30}
...
{\formatdate{23}{3}{2026}}{\formatdate{26}{4}{2026}}
{200}

\ACTadd{WP-3}{1}{dummy}{30}
...
{\formatdate{27}{4}{2026}}{\formatdate{24}{5}{2026}}
{160}

\ACTadd{WP-4}{1}{dummy}{30}
...
}
{
    ...
    \item Presentation and supporting materials
}
{\formatdate{25}{5}{2026}}{\formatdate{14}{6}{2026}}
{120}

\ACTadd{WP-5}{1}{dummy}{30}
