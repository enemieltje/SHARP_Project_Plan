...
\begin{itemize}
    ...
    \item The research report shall answer the following question: `To what extent is a hydrogen fuel cell based power generation and delivery system that integrates a Solid Flow's cool gas generator and Stellar Space Industries' flow control unit feasible for extending the mission time for UAV's'
\end{itemize}
